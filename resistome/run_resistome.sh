...
readonly tmp_dir=${argmobrich}/analysis/datasheets/tmp
...
readonly e01=${tmp_dir}/MOCK_D01_megares_mapped_reads.sam
readonly d01=${tmp_dir}/MOCK_E01_megares_mapped_reads.sam
...
for sam_file in ${pilot_megares_sams[@]}; do
    python gen_resistome.py "${sam_file}"
done
